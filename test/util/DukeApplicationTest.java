...
public class DukeApplicationTest extends ApplicationTest {
    // typical dialog box submit button text
    ...
    protected void writeToInputDialog (String textInput) {
        // look up resulting dialog's input field using chain of JavaFX components
        write(lookup(".dialog-pane .text-field").query(), textInput);
